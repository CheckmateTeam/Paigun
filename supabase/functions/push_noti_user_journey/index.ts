...
serve(async (req) => {
  try {
    ...
    notification.contents = {
      en: `The journey you have joined just change the status to ${record.status}!`
    }
    ...
    return new Response(JSON.stringify({ onesignalResponse: onesignalApiRes }), {
      headers: { 'Content-Type': 'application/json', 'Authorization': 'Basic N2VkMmM1NjUtZTkyMy00ZTVkLTlhZTMtZDY2YTkzODI0YmMw'  },
    })
  } catch (err) {
