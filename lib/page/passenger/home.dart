...
// The promptForPushNotificationsWithUserResponse function will show the iOS or Android push notification prompt. We recommend removing the following code and instead using an In-App Message to prompt for notification permission
    ...
    final externalUserId = await context.read<UserInfo>().userinfo['id'];
    await OneSignal.shared.setExternalUserId(externalUserId);
  }

  @override
  Widget build(BuildContext context) {
    final isLoading = context.watch<PassDB>().isLoading;
                      ...
                      children: [
                        ...
                        Container(
                          ...
                          child: context.watch<PassDB>().journey.isEmpty
                              ...
                              : ListView.builder(
                                  itemCount:
                                      context.watch<PassDB>().journey.length,
